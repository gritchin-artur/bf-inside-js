...
// leave this code!
const temp = otherArray2[1]; // false
otherArray2[1] = otherArray2[2]; // otherArray2 [true, '', '']
otherArray2[2] = temp; // otherArray2 [true, '', false]
...
// leave this code!
otherArray3[1] = array3[2]; // otherArray3 ['bye', 'middle']
otherArray3[3] = array3[0]; // otherArray3 ['bye', 'middle', 'hi]
otherArray3[2] = array3[3]; // otherArray3 ['bye', 'middle', 'end', 'hi']
