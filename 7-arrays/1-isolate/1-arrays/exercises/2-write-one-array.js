...
const temp = plants[2]; // 'bush'
plants[2] = plants[0]; // ['carrot', 'tree', 'carrot', 'grass']
plants[0] = temp; // ['carrot', 'tree', 'bush', 'grass']
...
// leave this code as it is!
mixed[1] = false;
mixed[0] = mixed[1]; // [false, null, true, 'tall']
mixed[1] = null; // [false, null, true, 'tall']
