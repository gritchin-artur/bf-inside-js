...
const isPalindrome = (str = '') => {
  let normalized = str.replace(/[^a-z0-9]/g, '');
  let textReversed = normalized.split('').reverse().join('');
  return textReversed === normalized;
};
 ...
 */
const isJS = (txt = '') => {
  return txt.toLowerCase() === 'js' || txt.toLowerCase() === 'javascript';
};
